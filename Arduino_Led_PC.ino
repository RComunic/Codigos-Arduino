/*
  LED PC
  Al enviar un "1" desde la PC, el Arduino UNO 
  detecta y enciende un LED colocado en Pin 13

  * Funcionando Correctamente en REAL
*/
...
Serial.flush();              // Limpia el Buffer Serial de la PC
}
